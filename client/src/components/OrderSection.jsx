...
_🌐 Ordered via lyallpurbarbq.com_`;
  ...
  if (successOrder) {
    return (
      <section id="order" style={{ background: '#080808' }}>
        <div style={{ maxWidth: '600px', margin: '0 auto', padding: '100px clamp(24px, 5vw, 60px)', textAlign: 'center' }}>
          <div style={{ background: '#141414', border: '1px solid rgba(192,57,43,0.3)', borderRadius: '16px', padding: 'clamp(32px, 6vw, 60px)' }}>
            <div style={{ fontSize: '4rem', marginBottom: '20px' }}>🔥</div>
            <h2 style={{ fontFamily: "'Cinzel Decorative', serif", fontSize: 'clamp(1.5rem, 4vw, 2.2rem)', fontWeight: 700, color: '#F5F5F0', marginBottom: '12px' }}>
              Order Placed!
            </h2>
            <p style={{ fontFamily: "'Oswald', sans-serif", fontSize: '1.5rem', color: '#D4AC0D', letterSpacing: '0.1em', marginBottom: '16px' }}>
              {successOrder.orderNumber}
            </p>
            <p style={{ fontFamily: "'Lora', serif", fontSize: '1rem', color: '#C8C8C0', lineHeight: 1.7, marginBottom: '32px' }}>
      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '100px clamp(24px, 5vw, 60px)' }}>
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-14">
          ...
          <div className="w-full lg:w-[55%]">
            {/* Step 1 — Details */}
            <div className="mb-8">
              <h3 style={{ fontFamily: "'Oswald', sans-serif", fontSize: '1.1rem', color: '#F5F5F0', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '16px', borderLeft: '3px solid #C0392B', paddingLeft: '12px' }}>
                Your Details
              </h3>
            ...
            <div className="mb-8" style={{ marginTop: '28px' }}>
              ...
              {cart.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-8" style={{ background: '#141414', borderRadius: '10px', border: '1px solid rgba(192,57,43,0.15)' }}>
                ...
                <div className="space-y-3">
                  {cart.map(item => (
                    <div
                      ...
                      style={{ background: 'rgba(192,57,43,0.08)', borderRadius: '8px', border: '1px solid rgba(192,57,43,0.3)', transition: 'all 0.3s' }}
                    >
                      <div className="flex-1 min-w-0">
                        <span className="font-bold uppercase truncate block" style={{ fontFamily: "'Oswald', sans-serif", fontSize: '0.85rem', color: '#F5F5F0', letterSpacing: '0.05em' }}>
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        <span style={{ fontFamily: "'Oswald', sans-serif", fontSize: '1rem', color: '#F5F5F0', minWidth: '20px', textAlign: 'center' }}>{item.quantity}</span>
          ...
          <div className="w-full lg:w-[45%]">
            <div className="lg:sticky lg:top-24" style={{ background: '#141414', border: '1px solid rgba(192,57,43,0.3)', borderRadius: '12px', padding: '32px' }}>
              <h3 style={{ fontFamily: "'Oswald', sans-serif", fontSize: '1.2rem', color: '#F5F5F0', letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '20px' }}>
                Your Order
              </h3>
              ...
              <div className="space-y-2">
                ...
                {cart.map(c => (
                  <div key={c.id} className="flex justify-between" style={{ fontFamily: "'Lora', serif", fontSize: '0.9rem', color: '#C8C8C0' }}>
              ...
              <div className="space-y-2" style={{ fontFamily: "'Oswald', sans-serif" }}>
                <div className="flex justify-between" style={{ fontSize: '0.9rem', color: '#C8C8C0' }}>
                  <span>Subtotal</span>
                ...
                <div style={{ height: '1px', background: 'rgba(192,57,43,0.3)', margin: '12px 0' }} />
              ...
              <div className="mt-8 pt-6" style={{ borderTop: '1px solid rgba(192,57,43,0.2)' }}>
                <div className="space-y-3" style={{ fontFamily: "'Lora', serif", fontSize: '0.85rem', color: '#A0A09A' }}>
                  <p className="flex items-center gap-2"><FiPhone size={16} color="#E67E22" style={{ marginRight: '8px', flexShrink: 0 }} /> 0300-0000000</p>
                  <p className="flex items-center gap-2"><FiMapPin size={16} color="#E67E22" style={{ marginRight: '8px', flexShrink: 0 }} /> Faisalabad, Pakistan</p>
                  <p className="flex items-center gap-2"><FiClock size={16} color="#E67E22" style={{ marginRight: '8px', flexShrink: 0 }} /> Open Daily: 12 PM - 12 AM</p>
                </div>
              </div>
            </div>
          </div>
